...
fun IPClickableLinkText(
    ...
    val linkInfo = if (linkEntire) listOf(LinkInfo(text, 0, text.length)) else SpannableStr.getLinkInfo(text)
...
private class SpannableStr(source: CharSequence): SpannableString(source) {
    ...
    private val linkInfo: List<LinkInfo>
